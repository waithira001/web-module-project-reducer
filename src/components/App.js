...
import { ADD_ONE, APPLY_NUMBER, CHANGE_OPERATION, addOne, applyNumber, clearDisplay, memoryPlus, memoryRecall, memoryClear } from '../actions';
import './App.css';
...
function App() {
  ...
  const handleMemoryTotals=()=>{
    dispatch(memoryTotals(state.memory))
  }
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"MR"} onClick = {handleMemoryTotals}/>
